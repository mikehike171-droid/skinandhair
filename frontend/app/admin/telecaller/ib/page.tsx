...
export default function IBPatientsPage() {
  ...
  return (
    <PrivateRoute modulePath="admin/telecaller/ib" action="view">
      <div className="container mx-auto p-6 space-y-6">
      <h1 className="text-3xl font-bold">IB Patients</h1>
        ...
        <CardHeader>
          <div className="flex items-center gap-4">
            <div className="flex-1">
              <CardTitle>IB Patients ({filteredPatients.length})</CardTitle>
            </div>
