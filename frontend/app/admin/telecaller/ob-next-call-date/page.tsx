...
export default function OBNextCallDatePage() {
  ...
  const fetchNextCallDateNumbers = async (page = 1) => {
    try {
      ...
      let url = `${authService.getSettingsApiUrl()}/mobile-numbers/next-call-date?page=${page}&limit=${pagination.limit}&locationId=${locationId}`
  ...
  return (
    <div className="container mx-auto p-6 space-y-6">
      <h1 className="text-3xl font-bold">OB Next Call Date</h1>
                  ...
                  <div className="flex items-center gap-1">
                    {Array.from({ length: pagination.totalPages }, (_, i) => i + 1).map((page) => (
                      <Button
                        ...
                        size="sm"
                        onClick={() => fetchNextCallDateNumbers(page)}
                        className="w-8 h-8 p-0"
                      >
                        {page}
                      </Button>
