...
const mockAppointments: Appointment[] = [
  ...
  },
  {
    ...
    status: "rescheduled",
    type: "Consultation",
    notes: "Diabetes check-up - Patient requested time change",
    tokenNumber: "G003",
    consultationFee: 500,
    paymentStatus: "pending",
    bookedBy: "Telecaller - Mike",
  ...
  },
  {
    ...
    status: "no-show",
    type: "Consultation",
    notes: "Hypertension follow-up - Patient did not show up",
    tokenNumber: "C004",
    consultationFee: 800,
    paymentStatus: "paid",
    bookedBy: "Telecaller - Lisa",
    bookingDate: "2024-01-18",
    followUpRequired: true,
    lastContactDate: "2024-01-19",
  },
...
export default function TelecallerManageBookings() {
  ...
  const generateBillItems = (appointment: Appointment): BillItem[] => {
    ...
    // Add additional items based on appointment type and department
    ...
    if (appointment.department === "Pediatrics") {
      items.push({
        id: "5",
  ...
  const confirmCancelAppointment = () => {
    if (cancellingAppointment) {
      const updatedAppointment = {
        ...
        notes: `${cancellingAppointment.notes} | Cancelled by Telecaller: ${cancelReason}`,
      }
  ...
  const handleCallPatient = (appointment: Appointment) => {
    alert(`Calling ${appointment.patientName} at ${appointment.patientPhone}`)
  }

  const handleSendMessage = (appointment: Appointment) => {
    alert(`Sending message to ${appointment.patientName} at ${appointment.patientPhone}`)
  }
  ...
  const stats = {
    ...
    followUpRequired: filteredAppointments.filter((a) => a.followUpRequired).length,
  }

  return (
    <PrivateRoute modulePath="admin/telecaller/manage-bookings" action="view">
      ...
      <div className="flex-1 space-y-6">
        ...
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-gray-600">View, edit, reschedule, and follow up on appointments</p>
          </div>
            ...
            <CardContent className="p-4">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-2xl font-bold text-purple-600">{stats.followUpRequired}</p>
                </div>
                      ...
                      <TableCell>
                        <div>
                          ...
                          {appointment.lastContactDate && (
                            <div className="text-xs text-gray-500 mt-1">Last: {appointment.lastContactDate}</div>
                          )}
                        </div>
                      </TableCell>
                      <TableCell>
      ...
      <div className="w-80 flex-shrink-0">
        <BillSummaryPreview
          ...
          discounts={[{ type: "percentage", percentage: 5, description: "Telecaller Discount" }]}
              ...
              <div className="flex items-start gap-2">
                ...
                <div>
                  ...
                  <p className="text-sm text-yellow-700 mt-1">
                    ...
                    become available for other patients. Follow-up call may be required.
                  </p>
                </div>
              </div>
            </div>
