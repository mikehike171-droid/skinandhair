...
export default function EditHRPolicyPage({ params }: { params: { id: string } }) {
    const { id } = params
    ...
    const handleSubmit = async () => {
        ...
        setIsLoading(true)
        try {
            await settingsApi.updateHRPolicy(parseInt(id), {
                policyNumber,
                title: policyTitle,
                description
            })
    ...
    return (
        <PrivateRoute modulePath="admin/hr-management/policies" action="edit">
            <div className="p-6 space-y-6 bg-gray-50 min-h-screen">
                ...
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold text-gray-900">Edit HR Policy</h1>
                        <p className="text-sm text-gray-500">Update policy details and documentation</p>
                    </div>
                </div>
                ...
                <Card className="border shadow-sm bg-white rounded-xl overflow-hidden">
                    <CardContent className="p-6 space-y-6">
                        ...
                        <div className="pt-4 flex items-center justify-between border-t border-gray-50">
                            <p className="text-xs text-gray-400">* All fields are required to update the policy.</p>
