...
exports.CreateExpenseCategoryDto = exports.UpdateExpenseStatusDto = exports.CreateExpenseDto = void 0;
...
__decorate([
    (0, class_validator_1.IsNotEmpty)(),
    (0, class_validator_1.IsEnum)(employee_expense_entity_1.ExpenseStatus),
    __metadata("design:type", String)
...
__decorate([
    ...
    (0, class_validator_1.IsString)(),
    __metadata("design:type", String)
], UpdateExpenseStatusDto.prototype, "rejectionReason", void 0);
