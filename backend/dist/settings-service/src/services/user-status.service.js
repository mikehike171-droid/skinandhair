...
let UserStatusService = class UserStatusService {
    ...
    async findAll() {
        const result = await this.attendanceRepository.query('SELECT id, name as "statusName", color_code as "colorCode" FROM user_status WHERE status = true ORDER BY name ASC');
        return result;
    }
};
