...
let ModulesService = class ModulesService {
    constructor(moduleRepository, subModuleRepository) {
    ...
    getDefaultModulesWithSubModules() {
        return [
            {
                id: 1,
                name: 'Front Office',
    ...
    async createSubModule(subModuleData) {
...
exports.ModulesService = ModulesService = __decorate([
    ...
    __param(1, (0, typeorm_1.InjectRepository)(sub_module_entity_1.SubModule)),
