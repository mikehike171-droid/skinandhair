...
let DepartmentsController = class DepartmentsController {
    ...
    async getDepartmentsByLocation(body) {
        try {
...
__decorate([
    (0, common_1.Post)('by-location'),
    (0, swagger_1.ApiOperation)({ summary: 'Get departments by location ID' }),
    (0, swagger_1.ApiResponse)({ status: 200, type: [department_entity_1.Department] }),
    __param(0, (0, common_1.Body)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object]),
    __metadata("design:returntype", Promise)
], DepartmentsController.prototype, "getDepartmentsByLocation", null);
__decorate([
    (0, common_1.Get)(':id'),
...
exports.DepartmentsController = DepartmentsController = __decorate([
    (0, swagger_1.ApiTags)('Settings - Departments'),
